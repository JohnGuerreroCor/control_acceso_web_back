...
public class TicketRestController {
	...
	public Respuesta enviarTicketVisitanteEmail(@PathVariable String email, @PathVariable String nombre,
			@PathVariable String id, @PathVariable String lugar, @PathVariable String registro,
			@PathVariable String vigencia, @PathVariable String qr) {
